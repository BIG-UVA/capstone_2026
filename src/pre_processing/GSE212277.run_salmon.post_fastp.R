# parameters
read_dir <- "/standard/harrislab/capstone_2026/raw_reads/GSE212277/"
salmon_index <- "/standard/harrislab/capstone_2026/reference/mm_GRCm39_index/"
quant_root_dir <- "/standard/harrislab/capstone_2026/quants/GSE212277/"

fastq1_end <- "_1.fp_out.fastq.gz"
fastq2_end <- "_2.fp_out.fastq.gz"
